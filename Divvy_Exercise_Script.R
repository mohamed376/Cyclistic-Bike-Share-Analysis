...
getwd()
setwd("C:/Users/ebake/Desktop/Divvy_Exercise") #sets your working directory to simplify calls to data
...
"01 - Rental Details Duration In Seconds Uncapped","05 - Member Details Member Birthday Year",
...
write.csv(counts,file="C:\\Users\\ebake\\Desktop\\Divvy_Exercise\\avg_ride_length.csv")